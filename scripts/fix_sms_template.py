    ...
    with app.app_context():
        ...
        if not exam_template:
            ...
            exam_template = SmsTemplate(
                name='Exam Result Notification',
                subject='Exam Result',
                content='প্রিয় অভিভাবক, আপনার সন্তান {student_name} এর {subject} ({exam_title}) এ নম্বর: {marks_obtained}/{total_marks} ({percentage}) - গ্রেড: {grade}। Chemistry and ICT Care by Belal Sir',
